    ...
    <table class="table manage-grid">
        ...
        <tbody class="main">
            <tr data-id="1" class="visible-md visible-lg" v-for="(student, index) in pagination()">
                <td v-text="++index"></td>
                <td>
                    <a v-bind:href="`new/${student.id}`" v-if="student.second_name">{{student.last_name}} {{student.name.toString()[0].toUpperCase()}}. {{student.second_name.toString()[0].toUpperCase()}}.</a>
                    <a v-bind:href="`new/${student.id}`" v-else>{{student.last_name}} {{student.name.toString()[0].toUpperCase()}}.</a>
                </td>
                <td>
