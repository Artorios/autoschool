<template>
    <div>
        ...
        <div class="blockform" v-show="formShow">
            ...
            <form action="">
                <div class="row nero">
                    ...
                    <div class="col-xs-6 col-sm-2">
                        ...
                        <input v-model.trim="data.address" v-bind:class="{'input-error': errors.address}" id="address" type="text" class="data" placeholder="Адрес филиала" required="">
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            sendDataToServer () {
                ...
                this.data.city_id = this.autoschool.city_id
