        ...
        <form action="">
            <div class="row nero">
                ...
                <div class="col-xs-6 col-sm-4">
                    ...
                    <div class="data">
                        <input v-model.trim="data.address" v-bind:class="{'input-error': errors.address}" id="date" type="text" placeholder="Адрес филиала" required="">
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            sendDataToServer () {
                ...
                this.data.auto_school_id = this.autoschool.id
